...
int main(int argc, char **argv)
{
  ...
  if (man)
  {
    ...
    printf("  -m[=NUMBER],\t--maxlen[=NUMBER]\tNUMBER is the maximum length of log files (in number of characters) (5000 by default)\n");
  ...
  int logfileLenght = -1;  // lunghezza file di log (inizializzata a -1 per controllare inserimento utente, poi settata a 5000 se l'utente non indica nulla)
